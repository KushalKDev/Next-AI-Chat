        ...
        <div className='bg-white rounded-b-2xl shadow-xl border-x border-b border-slate-200 p-6 md:p-8 space-y-8'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <button
              ...
              className='flex-1 max-w-xs px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-lg shadow-md hover:shadow-lg transition-all active:scale-95'
            >
